                       ...
                       unsigned char *output )
{
    ...
    while( length-- )
    {
        ...
        /*
                            ...
                            +---------------+
                            | Nonce Counter | (nonce_counter)
                            +---------------+
                                    |
                                    |
                                    v
                        +-------------------------+
              key (ctx) | Block Cipher Encryption |
                        +-------------------------+
                                    |
                                    | (stream_block)
                                    |
        ...
        */
        ...
        if( n == 0 ) {
            ...
            for( i = MBEDTLS_BLOWFISH_BLOCKSIZE; i > 0; i-- ) {
                printf("%d ", nonce_counter[i-1]);
            }
            printf("\n");
            for( i = MBEDTLS_BLOWFISH_BLOCKSIZE; i > 0; i-- ) {
                printf("%d ", stream_block[i-1]);
            }
            printf("\n");

            // add counter (nonce_counter is a bignumber)
            for( i = MBEDTLS_BLOWFISH_BLOCKSIZE; i > 0; i-- ) {
        ...
        c = *input++;   // part of plain text
        *output++ = (unsigned char)( c ^ stream_block[n] ); // get cipher text (plain text ^ encryption)
